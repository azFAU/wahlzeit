...
import org.wahlzeit.model.JapanPhotoFactory;
import org.wahlzeit.model.JapanPhotoManager;
...
public abstract class ModelMain extends AbstractMain {
	...
	public void saveAll() throws IOException{
		...
		JapanPhotoManager.getInstance().savePhotos();
	...
	protected void createUser(String userId, String nickName, String emailAddress, String photoDir) {
		...
		JapanPhotoManager photoManager = JapanPhotoManager.getInstance();
